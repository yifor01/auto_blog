...
📌 【HuggingFace Papers】VideoChat3：4B 參數全開源影片 MLLM 兼顧效率與泛化

TL;DR：VideoChat3 以全開源與 I3D-ViT 設計，用 4B 參數超越同級開源影片模型。
...
在一般、長影片與串流基準上的實驗顯示，VideoChat3 僅用 4B 參數，便在同等或更大參數量的先前開源模型之上，且具更高效率。摘要未提供具體基準名稱與分數，僅宣告此結果。
