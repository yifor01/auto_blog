...
generated_at: 2026-03-03T19:53:32.445424
---

📌 **用工具驗證，讓 AI 自我學習更可靠**

Test-time reinforcement learning (TTRL) 讓大型推理模型能在測試時自我演化，但研究發現：當多數投票出現錯誤共識時，模型會陷入錯誤模式崩潰。這篇論文提出 T³RL，透過工具驗證來穩定自我學習過程。

🤔 **TTRL 的關鍵缺陷：錯誤共識變成自我強化**

當 AI 模型在測試時使用 TTRL 自我學習，它會透過多數投票產生自我獎勵。但如果錯誤答案被多數人選中，這個錯誤共識就會變成強化的獎勵信號，導致模型崩潰到錯誤模式。
