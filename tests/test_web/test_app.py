...
def test_day_detail_uses_contents(client, mock_data_service):
    ...
    mock_data_service.get_all_day_items.return_value = [
        {"title": "Test Post", "url": "https://example.com", "source": "arXiv",
         "source_name": "arXiv", "total_score": 80, "rule_score": 30,
         "llm_score": 50, "tags": [], "authors": [], "index": 0, "scored": True,
         "llm_reason": None, "organization": None},
    ]
...
def test_day_detail_passes_bookmarked_indices(client, mock_data_service):
    ...
    mock_data_service.get_all_day_items.return_value = [
        {"title": "Bookmarked Item", "url": "https://a.com", "source": "arXiv",
         ...
         "llm_score": 50, "llm_reason": None, "tags": [], "authors": [], "index": 0, "scored": True,
         "organization": None},
        {"title": "Normal Item", "url": "https://b.com", "source": "HN",
         "source_name": "Hacker News", "total_score": 70, "rule_score": 30,
         "llm_score": 40, "llm_reason": None, "tags": [], "authors": [], "index": 1, "scored": True,
         "organization": None},
    ]
    mock_data_service.list_day_contents.return_value = []
