...
3. **話題性 (Trending)** — 是否與當前 AI 社群熱議的話題相關？(如 Agent, Reasoning, MoE, 多模態等)
4. **實用性 (Practicality)** — 工程師能否立即從中受益？有開源工具/程式碼嗎？
5. **部落格適合度 (Blog-worthiness)** — 這個主題適合寫成引人入勝的科技部落格文章嗎？一般讀者會感興趣嗎？
...
"""
    ...
    try:
        ...
        if scores:
            item.llm_score = scores.get("total", 0)
